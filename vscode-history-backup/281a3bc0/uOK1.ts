...
async function decodeReviewFrame(
      ...
      output:
        (
          ...
          if (
            ...
            /*
             * Keep this VideoFrame alive only
             * until the transferable bitmap has
             * been created.
             */
            bitmapPromise =
              createImageBitmap(
  ...
  if (!bitmapPromise) {
    throw new Error(
      `WebCodecs did not output requested sample ${request.targetSampleIndex}.`,
    );
  }
