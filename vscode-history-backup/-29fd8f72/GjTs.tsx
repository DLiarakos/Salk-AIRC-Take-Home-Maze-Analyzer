...
<p>
  Small dashed circles show the calibrated physical hole ROIs.
  Solid circles show the inner trigger radius. Larger dashed
  circles show the outer sustain radius. Numbered markers show
  accepted investigation events.
</p>
