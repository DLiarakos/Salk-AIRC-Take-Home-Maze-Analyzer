...
import {
  applyArenaMaskForPreview,
  calculateMaskedIntensityStats,
  createArenaMask,
...
export default function ArenaMaskPreview({
  frame,
  calibration,
}: Props) {
  const canvasRef =
  ...
  return (
    <section
      aria-labelledby="arena-mask-heading"
    >
