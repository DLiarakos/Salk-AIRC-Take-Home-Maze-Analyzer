...
export default function TrajectoryComparisonView({
  processedTrajectory,
  background,
}: Props) {
  /*
  ...
  return (
    <section className="card" aria-labelledby="trajectory-comparison-heading">
      ...
      <div className="trajectory-comparison-grid">
        <figure>
          ...
          <canvas
            ...
            aria-label="Raw mouse trajectory"
          />
        ...
        <figure>
          ...
          <canvas
            ...
            className="calibration-canvas"
            aria-label="Smoothed mouse trajectory"
          />
